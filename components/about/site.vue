<template lang="pug">
	v-card(flat)
		...
		v-card-text(class="title")
			p 本サイトはβテスト中となります。提供している機能は断りなく変更、削除する可能性がございますのでご了承のほどよろしくお願いします。
		v-card-text(class="title")
			p また、問題に正答となっている漢字以外にも組み立てられる漢字を発見された場合はこちらにご報告いただけると大変助かります。
				| 確認次第twitterなどでその漢字を紹介させていただきますので、よろしくお願いします。
			p 連絡先：Email kanji.assembly@gmail.com
		v-card-text
